...
export function parseTokens(emmetTokens, rootSrc = '', groupCountLength = 0, groupCount = 0) {
    var _a, _b;
    ...
    for (let i = 0; i < emmetTokens.length; i++) {
        ...
        if (token.type === 'name') {
            ...
            if (operation === 'id') {
                previousTemplate === null || previousTemplate === void 0 ? void 0 : previousTemplate.setId(token.value);
                operation = '';
                continue;
            }
            if (groupCountLength) {
